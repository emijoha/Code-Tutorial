...
5. Imports html and api routes (lines 22 & 23)
  Requiring our route files, which returns a function that the 'app' express variable is then passed into with the second paranthesis.

Just like rivers empty into an ocean, all files evetually funnel into server.js
